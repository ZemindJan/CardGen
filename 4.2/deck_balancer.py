...
for deck in decks.values():
    ...
    print(f'High Cards:   {deck.high_cards}')
    print(f'Mid Cards:    {deck.mid_cards}')
    print(f'Low Cards:    {deck.low_cards}')
    print(f'Skill Cards:  {deck.skill_cards}')
    print(f'Total Cards:  {deck.total}')
